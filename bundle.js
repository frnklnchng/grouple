...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/Grouple.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./frontend/Grouple.jsx":
/*!******************************!*\
  !*** ./frontend/Grouple.jsx ***!
  \******************************/
...
var Auth = function Auth(_ref) {
  ...
  return _react2.default.createElement(_reactRouterDom.Route, { path: path, exact: exact, render: function render(props) {
      return !loggedIn ? _react2.default.createElement(Component, props) : _react2.default.createElement(_reactRouterDom.Redirect, { to: '/home' });
    } });
};
